...
header("location: ../randommod.php?mod=".$_POST['level']);	
}
?>
<header>
    <div class="buttonhead">
        <button class=" back" type=submit>
            <a href="../randommod.php?mod=<?php echo $_POST['mod'].'&id='.$_POST['id'];?>">
                <img class="backimg" src="../image/button/arrow.png">
            </a>
        </button>
        <a class="user" href="../users/userrandom.php?mod=<?php echo $_POST['mod'];?>">
...
<main class="main">
    <div class="up">
        ...
        <div class=" Choix">
            <form method="post" class="form" id="formLetter" action="settingrandommod.php?mod=<?php echo $_POST['level']?>">
