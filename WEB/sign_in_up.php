            ...
            <div class="container">
                <div class="login-container">
                    ...
                    <form class="sign-in-htm" action="traitement/traitement_connexion.php" method="post">
                        <?php
                                echo'<h2 class="comment">Connectez-vous à Martin Charpentier !</h2>';
                        ...
                        if(isset($_GET["state"]) && $_GET["state"] == "end"){
                            ...
                            <div class="group">
                                <input placeholder="Username" id="user" name="email" type="email" class="input" autocomplete="username" required pattern="^[A-Za-z0-9._%+-]+@(student\.)?junia\.com$">
                            </div>
                            <div class="group">
                    ...
                    <form class="sign-up-htm" action="traitement/traitement_inscription.php" method="post">
                        <h2 class="comment" >Inscrivez-vous rapidement sur Martin Charpentier !</h2>
                        <?php 
                        ...
                        <div class="group">
                            <input placeholder="Email address" id="email" name="email" type="email" class="input"
                                pattern="^[A-Za-z0-9._%+-]+@(student\.)?junia\.com$" autocomplete="email" autofocus="autofocus"
                                required>
                        </div>
                        <div class="group">
