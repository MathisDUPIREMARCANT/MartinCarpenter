...
<?php ?>
   huge = {"Islands":[{"id":"clone_8800","Placement":[2,2],"links":3},{"id":"clone_963","Placement":[6,6],"links":6}],"Grid":[{"size":["7","7"]}],"Bridges":[],"PlacedBridges":{}}
 console.log('aa', huge.Grid[0])


   console.log('aaaaa',huge);
